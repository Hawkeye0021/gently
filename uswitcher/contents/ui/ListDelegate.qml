...
Item {
    ...
    RowLayout {
        ...
        PlasmaCore.IconItem {
            ...
            Layout.minimumWidth: 0*units.iconSizes.small
            Layout.maximumWidth: 0*units.iconSizes.small
            Layout.minimumHeight: 1.5*units.iconSizes.small
            Layout.maximumHeight: 1.5*units.iconSizes.small
